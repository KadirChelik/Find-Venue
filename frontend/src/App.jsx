        ...
        <div className="app-main">
            <Routes>
                <Route path="/" element={<Template />}>
                    ...
                    <Route path="venue/:id/comment/new" element={<AddComment authControl={authControl} tokenCtrl={tokenCtrl} CommentName={CommentName}/>} />
                    <Route path="about" element={<About />} />
                    <Route path="login" element={<Login setAuthControl={setAuthControl} setTokenCtrl={setTokenCtrl} setCommentName={setCommentName}/>} />
